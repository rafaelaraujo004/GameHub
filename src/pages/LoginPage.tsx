      ...
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 text-sm">
            Sua biblioteca de jogos pessoal
          </p>
        </div>

        {/* Card */}
        <div className="bg-[#111827] border border-white/10 rounded-2xl p-8 shadow-2xl">
          <h2 className="text-white font-bold text-lg mb-1">Bem-vindo!</h2>
          <p className="text-gray-500 text-sm mb-6">
            Faça login para acessar e gerenciar seus jogos.
          </p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white text-gray-900
              py-3 rounded-xl font-semibold text-sm hover:bg-gray-100 active:scale-95
        ...
        <p className="text-center text-xs text-gray-600 mt-6">
          Apenas metadados são armazenados. Nenhum arquivo é hospedado.
        </p>
      </div>
    </div>
  );
